 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.coursework.impl.ProjectImpl#getPercentage <em>Percentage</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProjectImpl extends MinimalEObjectImpl.Container implements Project {
	...
	protected EClass eStaticClass() {
		return CourseworkPackage.Literals.PROJECT;
	}
	...
	public void setPercentage(float newPercentage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CourseworkPackage.PROJECT__PERCENTAGE, oldPercentage,
					percentage));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CourseworkPackage.PROJECT__PERCENTAGE:
