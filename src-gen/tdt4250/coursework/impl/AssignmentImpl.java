 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.coursework.impl.AssignmentImpl#getPercentage <em>Percentage</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssignmentImpl extends MinimalEObjectImpl.Container implements Assignment {
	...
	protected EClass eStaticClass() {
		return CourseworkPackage.Literals.ASSIGNMENT;
	}
	...
	public void setPercentage(float newPercentage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CourseworkPackage.ASSIGNMENT__PERCENTAGE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CourseworkPackage.ASSIGNMENT__PERCENTAGE:
